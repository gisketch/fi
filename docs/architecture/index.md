...
- [src](../../src): Application Source Code.
  ...
  - [components/MarkdownMessage.tsx](../../src/components/MarkdownMessage.tsx): Compact chat Markdown renderer with expandable heavy blocks; supports performant opacity-only text entrance without blur-heavy effects.
