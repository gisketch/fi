...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-full bg-black text-white safe-pt safe-pb select-none overflow-hidden relative font-sans-hermes">
        ...
        <div className="max-w-xl mx-auto space-y-8">
          ...
          {messages.length === 0 && (
            ...
            >
              ...
              <p className="font-serif-hermes text-[13px] italic leading-relaxed text-neutral-500 max-w-[180px] mx-auto">
              ...
              {messages.map((msg) => {
                ...
                if (isUser) {
                  return (
                    ...
                    >
                      <div className="font-sans-hermes text-[14px] font-light text-neutral-400 whitespace-pre-wrap break-words leading-relaxed italic">
                        {msg.content}
                      </div>
                    </motion.div>
                  );
                ...
                return (
                  ...
                  >
                    {msg.content ? (
                      <div className="font-serif-hermes text-[16px] leading-relaxed text-zinc-200 whitespace-pre-wrap break-words">
                        {msg.content}
                      </div>
                    ) : !hasTools ? (
                    ...
                    {hasTools && (
                      <div className="w-full pt-2 font-mono text-[11px] text-neutral-500 select-none">
                        <button
                          tabIndex={-1}
      ...
      {runningTool && !isPromptExpanded && (
        <div className="absolute bottom-28 left-6 right-6 z-35 flex justify-center pointer-events-none select-none">
          <motion.div 
            ...
            exit={{ opacity: 0 }}
            className="font-mono text-[11px] uppercase tracking-wider text-neutral-450 bg-neutral-950/80 backdrop-blur border border-white/5 py-1 px-3 rounded-full flex items-center gap-2"
          >
      ...
      {error && (
        <div className="mx-6 mb-4 px-4 py-2 bg-neutral-950 border border-neutral-900 rounded-xl flex items-center justify-between text-[12px] text-neutral-500 font-mono z-40 select-none">
          ...
          <button 
            ...
            className="text-[11px] font-bold text-white uppercase border border-neutral-800 px-2 py-0.5 rounded cursor-pointer"
          >
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono tracking-wide text-neutral-450 text-[13px]">
            ...
            >
              ...
              <textarea
                ...
                placeholder="Ask Fi..."
                className="w-full bg-transparent border-none outline-none text-[14px] font-light text-white placeholder-neutral-500 resize-none font-sans-hermes no-scrollbar min-h-[24px] max-h-32 pr-2 leading-relaxed"
                style={{ height: '24px' }}
              />
